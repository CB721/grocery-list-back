...
module.exports = {
    ...
    getUserByEmail: function (req, res) {
        ...
        function sendCompleteUser() {
            ...
            const columns = "id, first_name, last_name, email, last_visit, phone, joined, user_auth, using_PWA, dark_mode, TIMEDIFF(NOW(), last_pwa_prompt) AS last_pwa_prompt_diff";
            sqlDB
